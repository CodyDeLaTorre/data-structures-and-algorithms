...
let findShortest = (data) => {
  let shortestObject = data.reduce((shortestSoFar, currentChar) => {
    return parseInt(shortestSoFar.height) > parseInt(currentChar.height) ?  currentChar : shortestSoFar
  });
  return shortestObject.name
};
